...
<body>
	...
	<nav id="navbar"> <a href="index.jsp" class="menu">HOME</a> <a
		href="#" class="menu">ABOUT US</a> <a href="#" class="menu">CONTACT
		US</a> </nav>



	<form action="register.nsp" method="get" onsubmit="return (validate() && checkPassword()) && phoneNumber()">
